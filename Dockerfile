...
ENV RCLONE_VFS_READ_OPTIONS_CACHING "--dir-cache-time=72h --poll-interval=22h --vfs-cache-poll-interval=23h --vfs-cache-max-age=73h"
ENV RCLONE_CLOUD_OPTIONS_CACHING "--dir-cache-time=74h --poll-interval=24h"
