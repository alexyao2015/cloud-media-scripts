...
ENV RCLONE_VFS_READ_OPTIONS "--allow-other --buffer-size=2048M --drive-chunk-size=256M --vfs-read-chunk-size=256M --vfs-read-chunk-size-limit=0 --transfers=10 --rc --tpslimit=5 -vv"
ENV RCLONE_CLOUD_OPTIONS ""
ENV RCLONE_VFS_READ_OPTIONS_CACHING "--dir-cache-time=72h --poll-interval=55s --vfs-cache-poll-interval=1m0s --vfs-cache-max-age=73h"
ENV RCLONE_CLOUD_OPTIONS_CACHING "--dir-cache-time=74h --poll-interval=55s"
