...
ENV RCLONE_VFS_READ_OPTIONS "--buffer-size=2048M --drive-chunk-size=256M --vfs-read-chunk-size=256M --vfs-read-chunk-size-limit=0 --transfers=10 --rc --tpslimit=5 -vv"
